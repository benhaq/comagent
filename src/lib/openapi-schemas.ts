...
export const ChatSessionSchema = z
  .object({
    ...
    userId: z
      .string()
      .uuid()
      .openapi({ example: "f0e1d2c3-b4a5-6789-0abc-def123456789" }),
...
export const ChatMessageSchema = z
  .object({
    ...
    content: z
      .unknown()
      .openapi({ example: "What running shoes do you recommend?" }),
...
export const UserProfileSchema = z
  .object({
    ...
    walletAddress: z
      .string()
      .nullable()
      .openapi({ example: "0xDeAdBeEf00000000000000000000000000000001" }),
...
export const CartItemSchema = z
  .object({
    id: z
      .string()
      .uuid()
      .openapi({ example: "c1d2e3f4-a5b6-7890-cdef-123456789012" }),
    userId: z
      .string()
      .uuid()
      .openapi({ example: "f0e1d2c3-b4a5-6789-0abc-def123456789" }),
    ...
    image: z
      .string()
      .url()
      .openapi({ example: "https://example.com/shoe.jpg" }),
    size: z.string().openapi({ example: "10" }),
    color: z.string().openapi({ example: "Black" }),
    productUrl: z
      .string()
      .url()
      .openapi({ example: "https://amazon.com/dp/B0CXYZ1234" }),
